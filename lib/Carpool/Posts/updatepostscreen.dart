...
class UpdatePostScreen extends StatefulWidget {
  ...
  UpdatePostScreen({Key? key,required this.id,required this.fare }) : super(key: key);
...
class _UpdatePostScreenState extends State<UpdatePostScreen> {
  ...
  void initState() {
    ...
    super.initState();
    contentController = widget.fare != null && widget.fare.isNotEmpty
        ? TextEditingController(text: widget.fare)
                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      child: Center(
                        child: Container(
                          ...
                          color: Colors.black,
                          child: Text(
                            'I am pleased to inform you that the fare for a 100-kilometer journey will be priced at a reasonable rate of 1000 Rs. This cost-effective fare ensures that our passengers can enjoy a comfortable and convenient travel experience without burdening their wallets. ',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 11,
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        await firebaseFirestore.collection("driverPost").doc(widget.id).update({
                          "totalFare":contentController.text,
