...
import 'package:sath_chalien_driver/assistants/assistant_methods.dart';
                    ...
                    onPressed: () {
                      ...
                      FirebaseDatabase.instance
                        ...
                        Fluttertoast.showToast(
                            msg:
                                "Ride Request has been Cancelled, Successfully.");
                      });
  ...
  acceptRideRequest(BuildContext context) {
    ...
    FirebaseDatabase.instance
      ...
      if (getRideRequestId == widget.userRideRequestDetails!.rideRequestId) {
        ...
        Fluttertoast.showToast(msg: "This Ride  do not exists.");
      }
    });
  }
}
